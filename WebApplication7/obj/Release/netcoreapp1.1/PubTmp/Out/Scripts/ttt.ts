...
function markBoard(state: State) {
    var num;
...
function getNextStates(state: State) {
...
function calculateScore(state: State, level: number) {
    var num = 0;
...
function computerGamePlay(state: State, level: number) {
    level--;
